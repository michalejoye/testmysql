...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ISLambdaCSharp.Functions*):

Restore dependencies
```
    cd "ISLambdaCSharp.Functions"
    dotnet restore
```

Execute unit tests
```
    cd "ISLambdaCSharp.Functions/test/ISLambdaCSharp.Functions.Tests"
    dotnet test
```

Deploy application
```
    cd "ISLambdaCSharp.Functions/src/ISLambdaCSharp.Functions"
